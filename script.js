    ...
    BuildLoginForm: function (loadFromOngoingRescue) {
        ...
        if (rescuePlugin.UseClientForm) {
            ...
            if (rescuePlugin.TestMode) {
                ...
                document.styleSheets[0].insertRule('#kiwi .server_select.initial:before { background: #FFFFFF !important; }', -1);
                document.styleSheets[0].insertRule('#kiwi button { background: #e6434b !important; color: #FFFFFF !important; }', -1);
                // #e6434b
